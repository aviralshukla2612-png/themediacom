...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ $global_seo['favicon_image'] ?? asset('mediaconlogo_nav.png') }}">
    <link rel="apple-touch-icon" href="{{ $global_seo['favicon_image'] ?? asset('mediaconlogo_nav.png') }}">
