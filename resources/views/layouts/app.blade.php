...
<head>
    ...
    <meta property="og:image" content="@yield('seo_image', asset($global_seo['seo_image'] ?? 'websitefinal.png'))">
...
<body>
    ...
    <nav class="navbar">
        <div class="container">
            <a href="{{ route('home') }}" class="logo" style="display: flex; align-items: center;"><img src="{{ $global_seo['logo_image'] ?? asset('websitefinal.png') }}" alt="{{ $global_seo['site_name'] ?? 'The Media Com' }}" style="height: 80px; width: auto;"></a>
                ...
                <div class="footer-about">
                    <a href="{{ route('home') }}" class="logo"
                        style="display: inline-block; margin-bottom: 1.5rem; margin-left: -1.5rem;"><img
                            src="{{ $global_seo['logo_image'] ?? asset('websitefinal.png') }}" alt="{{ $global_seo['site_name'] ?? 'The Media Com' }}"
